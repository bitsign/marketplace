            ...
            <div class="col-md-6 d-flex flex-column align-items-center justify-content-center">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(route('vendor.password.update')); ?>" class="row g-3">
                        <?php echo csrf_field(); ?>
                            <div class="col-12">
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/architus/resources/views/vendor/reset-password.blade.php ENDPATH**/ ?>