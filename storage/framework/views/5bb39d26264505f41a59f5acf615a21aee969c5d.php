                    ...
                    <div class="table-responsive">
                        <table class="table table-striped sortable table-hover">
                            ...
                            <?php if(!empty($portfolios)): ?>
                                ...
                                <tr id="item-<?php echo e($portfolio->id); ?>">
                                    <td><a class="handle1 btn btn-primary btn-xs"><i class="bi bi-arrow-down-up"></i></a></td>
                                    <td><a href="<?php echo e(route('portfolios.edit', $portfolio->id)); ?>"><?php echo e($portfolio->name); ?></a></td>
                                    <td><?php echo e($portfolio->created_at); ?></td>
                                    <td><?php echo e($portfolio->updated_at); ?></td>
                                    <td>
                                        <div class="btn-group" style="float:right">
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(route('portfolios.edit', $portfolio->id)); ?>"><i class="bi bi-tools"></i></a>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/architus/resources/views/admin/portfolio/index.blade.php ENDPATH**/ ?>