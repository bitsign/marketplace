                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <?php if(!empty($blocks)): ?>
                                ...
                                <tr>
                                    <td><?php echo e($block['id']); ?></td>
                                    <td><?php echo e($block['name']); ?></td>
                                    <td><?php echo e($block['title']); ?></td>
                                    <td>
                                        <?php echo $block['active'] == 1 ? "<span class='badge bg-success'>".__('yes')."</span>" : "<span class='badge bg-danger'>".__('no')."</span>"; ?>

                                    </td>
                                    <td>
                                        <div class="btn-group" style="float:right">
                                            <a class="btn btn-primary btn-xs" href="blocks/<?php echo e($block['id']); ?>"><i class="bi bi-tools"></i></a>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/architus/resources/views/admin/blocks/blocks.blade.php ENDPATH**/ ?>