                    ...
                    <div class="table-responsive">
                        <table class="table table-striped sortable table-hover">
                            ...
                            <?php if(!empty($payments)): ?>
                                ...
                                <tr id="item-<?php echo e($payment->id); ?>">
                                    <td><a class="handle1 btn btn-primary btn-xs"><i class="bi bi-arrow-down-up"></i></a></td>
                                    <td><a href="<?php echo e(route('payment-methods.edit',$payment->id)); ?>"><?php echo e($payment->name); ?></a></td>
                                    <td>
                                        <?php echo $payment->active == 1 ? '<span class="badge bg-success">'.__('yes').'</span>' : '<span class="badge bg-danger">'.__('no').'</span>'; ?>

                                    </td>
                                    <td>
                                        <div class="btn-group" style="float:right">
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(route('payment-methods.edit',$payment->id)); ?>"><i class="bi bi-tools"></i></a>
                                            <form action="<?php echo e(route('payment-methods.destroy', $payment->id)); ?>" method="post">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/architus/resources/views/admin/payments/index.blade.php ENDPATH**/ ?>