...
<?php $__currentLoopData = $childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   ...
   <li>
        ...
        <?php echo count($child->children) ? '<i class="bi bi-chevron-right"></i>' :''; ?>

        <?php if(count($child->children)): ?>
            <?php echo $__env->make('layout.menu.subcategories',['childs' => $child->children,'depth'=>$child->depth], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
   </li>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</ul>
<?php /**PATH /var/www/html/architus/resources/views/layout/menu/subcategories.blade.php ENDPATH**/ ?>