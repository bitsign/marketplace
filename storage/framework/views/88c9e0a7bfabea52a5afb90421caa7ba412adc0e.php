                ...
                <div class="btn-group ms-auto me-4">
                  <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                    <span class="mx-1">
                        ...
                        <span class="d-none d-sm-inline"><?php echo e(session('AdminUser')['name'] ?? ""); ?></span>
                    </span>
                  </button>
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a href="<?php echo e(route('administrators.edit',session('AdminUser')['id'])); ?>" class="dropdown-item btn btn-default btn-flat">
...
<?php /**PATH /var/www/html/myshop/resources/views/admin/layout/app.blade.php ENDPATH**/ ?>