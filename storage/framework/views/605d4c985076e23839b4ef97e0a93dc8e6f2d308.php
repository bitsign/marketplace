                    ...
                    <div class="table-responsive">
                        <table class="table table-striped sortable table-hover">
                            ...
                            <?php if(!empty($faqs)): ?>
                                ...
                                <tr id="item-<?php echo e($faq['id']); ?>">
                                    <td><a class="handle1 btn btn-primary btn-xs"><i class="bi bi-arrow-down-up"></i></a></td>
                                    <td><?php echo e($faq['name']); ?></td>
                                    <td>
                                        <div class="btn-group" style="float:right">
                                            <a class="btn btn-primary btn-xs" href="faqs/<?php echo e($faq['id']); ?>"><i class="bi bi-tools"></i></a>
                                            <form action="<?php echo e(route('faqs.destroy', $faq)); ?>" method="post">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/architus/resources/views/admin/faqs/index.blade.php ENDPATH**/ ?>