            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped sortable_tr table-hover">
                            <thead>
                                <tr>
                            ...
                            <?php if(!empty($shippings)): ?>
                                ...
                                <tr id="item-<?php echo e($shipping->id); ?>">
                                    <td><a class="handle1 btn btn-primary btn-xs"><i class="bi bi-arrow-down-up"></i></a></td>
                                    <td><a href="<?php echo e(route('shipping-methods.edit',$shipping->id)); ?>"><?php echo e($shipping->name); ?></a></td>
                                    <td>
                                        <?php echo $shipping->active == 1 ? '<span class="badge bg-success">'.__('yes').'</span>' : '<span class="badge bg-danger">'.__('no').'</span>'; ?>

                                    </td>
                                    <td>
                                        <div class="btn-group" style="float:right">
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(route('shipping-methods.edit',$shipping->id)); ?>"><i class="bi bi-tools"></i></a>
                                            <form action="<?php echo e(route('shipping-methods.destroy', $shipping->id)); ?>" method="post">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/architus/resources/views/admin/shippings/index.blade.php ENDPATH**/ ?>