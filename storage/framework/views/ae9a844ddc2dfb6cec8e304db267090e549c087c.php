                    ...
                    <div class="table-responsive">
                        <table class="table table-striped sortable table-hover">
                            ...
                            <?php if(!empty($posts)): ?>
                                ...
                                <tr>
                                    <td><a href="<?php echo e(route('posts.edit',$post->id)); ?>"><?php echo e($post->name); ?></a></td>
                                    <td>
                                        <?php echo $post->published == 1 ? '<span class="badge bg-success">'.__('yes').'</span>' : '<span class="badge bg-danger">'.__('no').'</span>'; ?>
                                    ...
                                    <td>
                                        <div class="btn-group" style="float:right">
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(route('posts.edit',$post->id)); ?>"><i class="bi bi-tools"></i></a>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/architus/resources/views/admin/posts/index.blade.php ENDPATH**/ ?>