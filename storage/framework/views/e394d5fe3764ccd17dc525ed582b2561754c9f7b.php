...
<div class="row mb-3">
    ...
    <div class="col-lg-2">
        ...
        <img class="m-auto" style="max-height:150px" src="<?php echo e(url('files/products/small/'.$img['filename'])); ?>">
...
<?php /**PATH /var/www/html/architus/resources/views/admin/products/components/images-form.blade.php ENDPATH**/ ?>