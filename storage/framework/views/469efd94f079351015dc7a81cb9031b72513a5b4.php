        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <form method="post" action="<?php echo e(route('pages.update', $page)); ?>" class="form-horizontal" role="form"
                        id="page_form">
                                ...
                                <?php $__currentLoopData = config('app.available_locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="input-group mb-1">
                                        ...
                                        <input name="name[<?php echo e($lang); ?>]" type="text"
                                            value="<?php echo e($translations[$lang]['name'] ?? ''); ?>" class="form-control" required>
                                    </div>
                                    <input type="hidden" name="translation_id[<?php echo e($lang); ?>]"
                                        value="<?php echo e($translations[$lang]['id'] ?? ''); ?>">
                        ...
                        <?php $__currentLoopData = config('app.available_locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="editor form-control" name="content[<?php echo e($lang); ?>]" rows="10" cols="80"><?php echo e($translations[$lang]['content'] ?? ''); ?></textarea>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = config('app.available_locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="input-group mb-1">
                                        ...
                                        <input name="meta_description[<?php echo e($lang); ?>]" type="text"
                                            value="<?php echo e($translations[$lang]['meta_description'] ?? ''); ?>"
                                            class="form-control">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                                ...
                                <?php $__currentLoopData = config('app.available_locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="input-group mb-1">
                                        ...
                                        <input name="meta_keywords[<?php echo e($lang); ?>]" type="text"
                                            value="<?php echo e($translations[$lang]['meta_keywords'] ?? ''); ?>" class="form-control">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                                ...
                                <?php $__currentLoopData = config('app.available_locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="input-group mb-1">
                                        ...
                                        <input name="menu_title[<?php echo e($lang); ?>]" type="text"
                                            value="<?php echo e($translations[$lang]['menu_title'] ?? ""); ?>" class="form-control">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-10">
                                <select name="parent_id" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $pages_dd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page_id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($page_id); ?>"
                                            <?php echo e($page_id == $page['parent_id'] ? 'selected' : ''); ?>><?php echo e($name); ?>
                                ...
                                <select name="type" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $pages_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type->type); ?>"
                                            <?php echo e($type->type == $page['type'] ? 'selected' : ''); ?>>
                                            <?php echo e(__('admin.' . $type->type)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-10">
                                <div class="input-group col-lg-12">
                                    <input id="fieldID" type="text"
                                        value="<?php echo e(@!empty($page['image']) ? $page['image'] : ''); ?>" name="image"
                                        class="form-control">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-10">
                                <input type="checkbox" data-onstyle="success" data-offstyle="danger" data-size="mini"
                                    ...
                                    <?php echo e(!empty($page['menu']) || empty($page['id']) ? 'checked' : ''); ?> />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-10">
                                <input type="checkbox" data-onstyle="success" data-offstyle="danger"
                                    ...
                                    <?php echo e(!empty($page['footmenu']) || empty($page['id']) ? 'checked' : ''); ?> />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-10">
                                <input type="checkbox" data-onstyle="success" data-offstyle="danger"
                                    ...
                                    <?php echo e(!empty($page['active']) || empty($page['id']) ? 'checked' : ''); ?> />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-10">
                                <input type="checkbox" data-onstyle="success" data-offstyle="danger"
                                    ...
                                    <?php echo e(!empty($page['front_page']) ? 'checked' : ''); ?> />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-lg-2 text-lg-end"><?php echo e(__('admin.sort_order')); ?></label>
                            <div class="col-lg-10">
                                <input name="sort" value="<?php echo e($page['sort'] ?? 0); ?>" type="text"
                                    class="form-control">
                            </div>
                        </div>
                        <hr />
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/architus/resources/views/admin/pages/edit.blade.php ENDPATH**/ ?>