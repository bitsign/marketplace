        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <form method="post" action="<?php echo e(route('administrators.store')); ?>" class="form-horizontal" role="form" id="page_form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3 row">
                            <label class="col-lg-2 text-lg-end"><?php echo e(__('email')); ?> <code>*</code></label>
                            <div class="col-lg-8">
                        ...
                        <div class="mb-3 row">
                            <label class="col-lg-2 text-lg-end"><?php echo e(__('password')); ?> <code>*</code></label>
                            <div class="col-lg-8">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/architus/resources/views/admin/administrators/create.blade.php ENDPATH**/ ?>