                        ...
                        <table class="table table-striped" id="datatable">
                            ...
                            <?php if(!empty($manufacturers)): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('manufacturers.edit',$manufacturer['id'])); ?>">
                                            <?php echo e($manufacturer['name']); ?>

                                        </a>
                                    </td>
                                    <td>
                                        <?php echo $manufacturer['active'] == 1 ? "<span class='badge bg-success'>".__('yes')."</span>" : "<span class='badge bg-danger'>".__('no')."</span>"; ?>

                                    </td>
                                    <td>
                                        <div class="btn-group" style="float:right">
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(route('manufacturers.edit',$manufacturer['id'])); ?>"><i class="bi bi-tools"></i></a>
                                            <form action="<?php echo e(route('manufacturers.destroy', $manufacturer)); ?>" method="post">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/architus/resources/views/admin/manufacturers/index.blade.php ENDPATH**/ ?>