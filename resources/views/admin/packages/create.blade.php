        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <form method="post" action="{{ route('packages.store') }}" class="form-horizontal" role="form" id="package_form">
                        @csrf
                        ...
                        <div class="mb-3 row">
                            <label class="col-lg-2 text-lg-end">{{ __('admin.months') }}</label>
                            <div class="col-lg-8">
                        ...
                        <div class="mb-3 row">
                            <label class="col-lg-2 text-lg-end">{{ __('price') }} ({{ config('currency.default') }})</label>
                            <div class="col-lg-8">
                        ...
                        <div class="mb-3 row">
                            <label class="col-lg-2 text-lg-end">{{ __('action_price') }} ({{ config('currency.default') }})</label>
                            <div class="col-lg-8">
