        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <form method="post" action="{{ route('currencies.update',$currency->id) }}" class="form-horizontal" role="form" id="page_form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-8">
                                <input name="name" type="text" value="{{ $currency->name }}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-8">
                                <input name="code" type="text" value="{{ $currency->code }}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-8">
                                <input name="symbol" type="text" value="{{ $currency->symbol }}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-8">
                                <input name="format" type="text" value="{{ $currency->format }}" class="form-control" required>
                        ...
                        {{-- <div class="mb-3 row">
                            ...
                            <div class="col-lg-8">
                                <input name="exchange_rate" type="text" value="{{ $currency->exchange_rate }}" class="form-control" required>
                            </div>
                        </div> --}}
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-8">
                                <input type="checkbox" data-onstyle="success" data-offstyle="danger"
                                    ...
                                    data-toggle="toggle" name="active" value="1" {{ $currency->active == 1 ? "checked" : "" }} />
                            </div>
                        </div>
