        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <form method="post" action="{{ route('payment-methods.store') }}" class="form-horizontal"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-10">
                                <input name="value" type="text" value="{{ old('value', 0) }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-10">
                                <input name="sort" value="{{ old('sort', 0) }}" type="text" class="form-control">
                            </div>
                        </div>
                        <hr />
                        <div class="mb-3 row">
