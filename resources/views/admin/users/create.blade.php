        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <form method="post" action="{{ route('users.store') }}" class="form-horizontal" role="form"
                        id="add_user_form">
                        @csrf
                        <fieldset>
                            ...
                            <!--div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    {{-- custom_select('users_groups','group_id','id','title',old('group_id')) --}}
                                </div>
                            </div-->
                            <div class="mb-3 row">
                        ...
                        <fieldset>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <input name="billing_name" value="{{ old('billing_name') }}" type="text"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <input name="country" value="{{ 'Magyarország' }}" type="text" id="country"
                        ...
                        <fieldset>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <input name="country2"
                                        value="{{ old('country2') != '' ? old('country2') : 'Magyarország' }}"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <input name="state2" value="{{ old('state2') }}" type="text" id="state2"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <input name="zip2" value="{{ old('zip2') }}" type="number" id="zip2"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <input name="city2" value="{{ old('city2') }}" type="text" id="city2"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9" id="city_container">
                                    <input name="address2" value="{{ old('address2') }}" type="text"
