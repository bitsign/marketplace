                                ...
                                <div class="col-lg-10">
                                    @foreach (config('app.available_locales') as $lang)
                                        <div class="input-group mb-1">
                                            <span class="input-group-text"><img src="{{ url('assets/img/' . $lang . '.png') }}"
                                                    width="18px"></span>
                                            <input name="intro[{{ $lang }}]" type="text" value=""
                                                class="form-control" required>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="col-lg-10">
                                    @foreach (config('app.available_locales') as $lang)
                                        <div class="input-group mb-1">
                                            <span class="input-group-text"><img src="{{ url('assets/img/' . $lang . '.png') }}"
                                                    width="18px"></span>
                                            <input name="meta_title[{{ $lang }}]" type="text" value=""
                                                class="form-control">
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-select select2" name="tags[]" id="tags" multiple>
                                        <option value="" selected>{{ __('tags') }}</option>
                                        @foreach ($terms as $term)
                                            <option value="{{ $term->term_key }}">{{ $term->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-10">
                                    <input type="checkbox" data-onstyle="success" data-offstyle="danger"
                                        ...
                                        data-toggle="toggle" name="published" value="1" checked />
                                </div>
                            </div>
